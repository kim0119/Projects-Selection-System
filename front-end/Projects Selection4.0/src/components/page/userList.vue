        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="sex" label="sex">
                    <template slot-scope="scope">
                        <span v-if="scope.row.sex == 0">Woman</span>
                        <span v-if="scope.row.sex == 1">Man</span>
                    </template>
                </el-table-column>
                <el-table-column prop="roleId" label="Role">
                    <template slot-scope="scope">
                        <span v-if="scope.row.roleId == 0">Admin</span>
                        <span v-if="scope.row.roleId == 2">teacher</span>
                        <span v-if="scope.row.roleId == 1">student</span>
                    </template>
                </el-table-column>
